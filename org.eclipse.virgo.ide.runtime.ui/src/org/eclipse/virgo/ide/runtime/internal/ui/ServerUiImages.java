...
/**
 * The images provided by the Spring Beans UI plugin. Initialize the image registry by declaring all of the required
 * graphics. This involves creating JFace image descriptors describing how to create/find the image should it be needed.
 * The image is not actually allocated until requested. Prefix conventions Wizard Banners WIZBAN_ Preference Banners
 * PREF_BAN_ Property Page Banners PROPBAN_ Color toolbar CTOOL_ Enable toolbar ETOOL_ Disable toolbar DTOOL_ Local
 * enabled toolbar ELCL_ Local Disable toolbar DLCL_ Object large OBJL_ Object small OBJS_ View VIEW_ Product images
