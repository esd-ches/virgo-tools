...
public class ParPackageImpl extends EPackageImpl implements ParPackage {
	...
	public static ParPackage init() {
		...
		ParPackageImpl theParPackage = (ParPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ParPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ParPackageImpl());
